...
def binariza (img, threshold):
    ...
    img=np.where(img < threshold, img*0, 1) # se a intensidade do pixel for menor que o parâmetro do Thresold
    #retorna 0 (preto) identificando fundo, caso contrário retorna 1 (branco), identificando objeto 
    return(img)
